...
//		 /*4*/  selectAndSend(ProtocolType.mqtt);
	...
	protected void selectAndSend(ProtocolType protocol) throws Exception {
		String ip_labdisi = "130.136.113.239";
		String hostAddr = "";
		String entry = "";
		switch (protocol) {
		/* 1 */ case tcp: {
...
//    	     hostAddr = "localhost:8088/accessgui";
			hostAddr = ip_labdisi + ":8088/accessgui";
		...
		// switch
		/* 5 */ conn = ConnectionFactory.createClientSupport(protocol, hostAddr, entry);
