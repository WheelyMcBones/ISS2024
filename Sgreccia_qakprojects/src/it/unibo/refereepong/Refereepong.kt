...
class Refereepong ( name: String, scope: CoroutineScope, isconfined: Boolean=false  ) : ActorBasicFsm( name, scope, confined=isconfined ){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						observeResource("localhost","8015","ctxpong","pong","short")
				...
				state("win") { //this:State
					action { //it:State
						CommUtils.outred("Pong Ha PERSO!")
						forward("short", "short(win)" ,"pong" ) 
						 System.exit(0)  
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
