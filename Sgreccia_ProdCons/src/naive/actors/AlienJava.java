...
public class AlienJava extends ActorNaiveCaller {
	protected IApplMessage m = CommUtils.buildDispatch(name, "cmd", "hello_from_alien", "Consumer");
	protected IApplMessage r = CommUtils.buildRequest(name, "infoAlien", "request_from_alien", "Consumer");
